...
const ConsonantP = () => {
  ...
  const playSound = () => {
    ...
    const audio = new Audio(
      require("./../../../../../Assets/Audio/Consonants/P.mp3")
    );
    audio.play();
    setTimeout(() => {
      setPlaying(false);
    ...
    <div className="w-full relative wrapper">
      ...
      <div className="content relative z-10 h-full">
        ...
        <div className="body flex w-full justify-between items-center">
          <button
            onClick={() => navigate("/phonological-path/bd/consonantN")}
            disabled={playing}
          ...
          <div className="letter-group flex justify-between items-center">
            <img
              src={require("./../../../../../Assets/Images/Phonological/Alphabets Module/Consonants/Pp.png")}
              className="letter w-[374px] h-[263px] mr-10"
              alt=""
            />
            <img
              src={require("./../../../../../Assets/Images/Phonological/Alphabets Module/Consonants/17.png")}
