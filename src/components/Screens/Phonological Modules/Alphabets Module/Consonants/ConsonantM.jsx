...
const ConsonantM = () => {
  ...
  const playSound = () => {
    ...
    const audio = new Audio(
      require("./../../../../../Assets/Audio/Consonants/M.mp3")
    );
    audio.play();
    setTimeout(() => {
      setPlaying(false);
      ...
      <div className="content relative z-10 h-full">
        ...
        <div className="body flex w-full justify-between items-center">
          ...
          <div className="letter-group flex justify-between items-center">
            <img
              src={require("./../../../../../Assets/Images/Phonological/Alphabets Module/Consonants/Mm.png")}
              className="letter w-[374px] h-[263px] mr-10"
              alt=""
            />
            <img
              src={require("./../../../../../Assets/Images/Phonological/Alphabets Module/Consonants/15.png")}
