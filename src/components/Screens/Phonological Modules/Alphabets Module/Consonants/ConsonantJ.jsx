...
const ConsonantJ = () => {
  ...
  const playSound = () => {
    ...
    const audio = new Audio(
      require("./../../../../../Assets/Audio/Consonants/J.mp3")
    );
    audio.play();
    setTimeout(() => {
      setPlaying(false);
    ...
    <div className="w-full relative wrapper">
      ...
      <div className="content relative z-10 h-full">
        ...
        <div className="body flex w-full justify-between items-center">
          <button
            onClick={() => navigate("/phonological-path/bd/consonantH")}
            disabled={playing}
          ...
          <div className="letter-group flex justify-between items-center">
            <img
              src={require("./../../../../../Assets/Images/Phonological/Alphabets Module/Consonants/Jj.png")}
              className="letter w-[374px] h-[263px] mr-10"
              alt=""
            />
            <img
              src={require("./../../../../../Assets/Images/Phonological/Alphabets Module/Consonants/13.png")}
              className="object w-[286px] h-[313px]"
              alt=""
            />
          </div>
          <button
            onClick={() => navigate("/phonological-path/bd/consonantK")}
            disabled={playing}
            className="disabled:opacity-50"
          >
            <ChevronRight
