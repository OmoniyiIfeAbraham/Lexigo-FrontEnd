...
const ConsonantT = () => {
  ...
  const playSound = () => {
    ...
    const audio = new Audio(
      require("./../../../../../Assets/Audio/Consonants/T.mp3")
    );
    audio.play();
    setTimeout(() => {
      setPlaying(false);
      ...
      <div className="content relative z-10 h-full">
        ...
        <div className="body flex w-full justify-between items-center">
          ...
          <div className="letter-group flex justify-between items-center">
            <img
              src={require("./../../../../../Assets/Images/Phonological/Alphabets Module/Consonants/Tt.png")}
              className="letter w-[374px] h-[263px] mr-10"
              alt=""
            />
            <img
              src={require("./../../../../../Assets/Images/Phonological/Alphabets Module/Consonants/21.png")}
              className="object w-[286px] h-[313px]"
              alt=""
            />
          </div>
          <button
            onClick={() => navigate("/phonological-path/bd/consonantV")}
            disabled={playing}
            className="disabled:opacity-50"
          >
            <ChevronRight
