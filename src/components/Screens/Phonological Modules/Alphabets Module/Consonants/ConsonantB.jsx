...
const ConsonantB = () => {
  ...
  const playSound = () => {
    ...
    const audio = new Audio(
      require("./../../../../../Assets/Audio/Consonants/B.mp3")
    );
    audio.play();
    setTimeout(() => {
      setPlaying(false);
      ...
      <div className="content relative z-10 h-full">
        ...
        <div className="body flex w-full justify-between items-center">
          ...
          <div className="letter-group flex justify-between items-center">
            <img
              src={require("./../../../../../Assets/Images/Phonological/Alphabets Module/Consonants/Bb.png")}
              className="letter w-[374px] h-[263px] mr-10"
              alt=""
            />
            <img
              src={require("./../../../../../Assets/Images/Phonological/Alphabets Module/Consonants/7.png")}
              className="object w-[286px] h-[313px]"
              alt=""
            />
          </div>
          <button
            onClick={() => navigate("/phonological-path/bd/consonantC")}
            disabled={playing}
        ...
        >
          ...
          <div className="popup bg-white p-8 shadow-lg relative w-104 text-start">
            <p
              ...
              style={{ color: Colors.Black }}
            >
              Welcome to the consonant lesson little one <br /> Learn the sounds
              of the 21 consonant letters <br /> Play to hear the sounds <br />{" "}
              Follow along and do the quiz 😁
            </p>
